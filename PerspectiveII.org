...
** Week 4
#+BEGIN: clocktable :scope subtree :maxlevel 6 :tags t
#+CAPTION: Clock summary at [2021-03-22 Mon 21:19]
| Tags    | Headline                                         | Time   |      |      |      |
|---------+--------------------------------------------------+--------+------+------+------|
|         | *Total time*                                     | *7:52* |      |      |      |
|---------+--------------------------------------------------+--------+------+------+------|
...
| drawing | \_      NMA Linear Perspective                   |        |      |      | 2:31 |
| study   | \_      NMA Linear Perspective                   |        |      |      | 0:30 |
#+END:
#+BEGIN: clocktable-by-tag :scope subtree :maxlevel 6 :match ("drawing" "study" "prep")
| Tag     | Headline   | Time (h) |
...
|---------+------------+----------|
| study   | *Tag time* | *0h 30m* |
|---------+------------+----------|
| prep    | *Tag time* | *3h 46m* |
...
**** TODO NMA Linear Perspective 4 -                             :drawing:
