...
*** Gouache plein air
    ...
    - Intro to Gouache foudnation patreon
*** Studies
    - master studies
    - photo studies
...
* House
** DONE Francois
*** DONE remove all pet items
*** DONE board the boy
*** DONE wipe paws off back door glass
** DONE keep trash empty
** DONE Office
*** DONE take down white board
*** DONE clean base boards
*** DONE clean off desk
*** DONE dust monitors and computers
*** DONE clean cobwebs in ceiling corners
*** DONE remove Wrightson art
** DONE clear all surfaces
...
*** DONE sweep
*** DONE clean cabinets
*** DONE clean trash cabinet
*** DONE clear kitchen table
*** DONE clean walls
...
** DONE remove foam
** DONE Need attorney to sell house
*** DONE call Kate Murray (217) 531-1188
*** DONE forward Kate contract once we have it
** TODO Clean fridge
** TODO change air filter
** TODO crawl space
*** TODO check for turds
*** TODO remove trap
** TODO Fix windshield crack
...
* Shopping
** TODO Sedative for Francois
** TODO Watch compatible with polar h10
** TODO pull up bar
