...
*** MWF
**** Morning
    - finish spring classes for portfolio
**** Afternoon
    - house
**** Evening
    - study painting
...
* Janos - Learning good shape design
** fill a pinterest board with images you find visually interesting
*** the more abstract, the better
** draw them!
*** start with silhouette, or outline of big shape
**** identify active vs passive sides
*** look at biggest interior shapes
*** use only C,S,I lines
*** make each plane an interesting shape
*** make sure each shape as active and passive side

* House
** TODO email Ronda about HOA dues
** TODO Need attorney to sell house
*** DONE call Kate Murray (217) 531-1188
*** TODO forward Kate contract once we have it
** DONE paint
*** DONE living room ceiling
*** DONE dining room wall
*** DONE exterior damaged areas
*** DONE interior damaged areas
** DONE deck
*** DONE pressure wash
*** DONE repaint
*** DONE replace caps
** TODO kitchen
*** DONE clear countertops
*** DONE clean sink
*** DONE clean microwave and stove
*** DONE clean fridge
*** DONE sweep
*** TODO clean cabinets
*** TODO clean trash cabinet
*** TODO clear kitchen table
*** TODO clean walls
*** DONE clear off washer and dryer
*** TODO clean inside of fridge
*** TODO clear broom closet
*** TODO sweep
*** TODO mop
** TODO bath
*** DONE clean shower
...
*** DONE clean toilet
*** DONE mirrors
*** DONE fix master toilet
*** TODO sweep
*** TODO mop
** DONE Art room
*** DONE 18x24 container?
*** DONE photograph early art
*** DONE remove light
*** DONE clear out as much as possible
*** DONE pack everything
** DONE Exercise room
*** DONE clean dust
*** DONE organize
*** DONE remove mirrors
** TODO crawl space
*** TODO check for turds
*** TODO remove trap
** TODO Francois
*** TODO remove all pet items
*** TODO board the boy
** TODO change air filter
** TODO keep trash empty
** TODO good will
*** TODO books
*** TODO clothes
*** TODO electronics
** TODO general cleaning
*** TODO vacuum and mop all floors
*** TODO dust everything
** TODO Office
*** DONE clean base boards
*** DONE clean off desk
*** DONE dust monitors and computers
*** DONE clean cobwebs in ceiling corners
*** TODO take down white board
*** TODO remove Wrightson art
** DONE clean moss on roof
** DONE caulk top of chimney
** DONE shampoo bedroom carpet
** DONE remove hornet nests from front door
** DONE replace front doormat
** DONE mulch front flower bed
** DONE remove foam
...
* Shopping
** TODO thumb screws for Francois's crate
** TODO magic erasers?
** DONE intelligentsia coffee
** DONE 1 gallon toasted cashew
** DONE 2 gallons porpoise
** DONE 1 gallon white
** DONE bleach
** DONE small boxes
** DONE mattress bag
...
When thinking of ways to improve a drawing, consider the magic number 3.
  ...
  - Rule of Thirds : This is followed by splitting a canvas into thirds
    horizontally and vertically and assigning your focal to a point where two of
    the interior lines interesect.
  - 3 "reads" -- primary read (overall impression), secondary read (additional
    info), tertiary read (more fun details to notice -- "garnish")
