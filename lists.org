...
** 2 classes (3d, painting)
*** TODO Pedro Blanco scifi envioronment design (3d)
*** TODO Kevin Jick Japanese stilt city (3d)
*** TODO James Paick environment design (painting)
*** TODO Maceij Environment painting learn squared (painting)
*** TODO Nathan Fowkes schoolism (painting)
*** TODO Romain Jouandeau (3d)
*** TODO gouache plein air
