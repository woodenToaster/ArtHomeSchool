...
* Shaddy on shapes
** rough 3d for perspective
** black and white, focusing on shapes
*** EVERY stroke is a samurai tshing!!!
*** big, strong strokes
* Shaddy digital painting
** 1 - Block in
*** Always start with Daniels
**** don't leave a dull flat end on a stroke. cut back in
*** identify horizon line
*** start in grayscale
*** capture simplistic essence of each shape (rhythm)
*** big, strong strokes
*** paint in, cut out
*** "design shapes" means "make them cool"
*** decide what focal point is, and everything else is subject to it
**** nothing should compete with focal point
** 2 - Styling shapes

* Learning good shape design
...
* House
** TODO caulk top of chimney
** TODO remove hornet nests from front door
** TODO paint
...
** TODO bath
*** TODO clear countertops
*** TODO fix master toilet
** TODO shampoo bedroom carpet
** TODO replace front doormat
** TODO mulch front flower bed
** TODO remove foam
** TODO clean moss on roof
** TODO crawl space
