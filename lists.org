...
**** concept artist
*** Cost
**** Florence: 50K in tutition, + ~60K cost of living for 3 years
*** Benefit
**** Live in Italy!
** Neuroscience
*** Prep
**** KU BS in Molecular, Cellular, and Developmental Biology
**** PhD
*** Job
**** Lab researcher
**** computational neuroscientis
*** Cost
**** BS: $30-$50K, depending on residency status, plus 20K per year cost of living
**** PhD: < $5K for living expenses assuming a stipend of $20K, X 5 years = 25-30K
*** Benefit
**** Understand and make discoveries about the human brain and body
** Programming
*** Prep
**** MS in computer graphics at U of Utah
*** Job
**** game programming
**** scientific programming
**** compiler engineer
*** Cost
**** MS: 5K cost of living per year, assuming an 18K stipend
*** Benefit
**** Not sure I can stand a normal programming job
**** Definitely not into CS research
** Chef
*** Prep
**** JCCC Chef Apprenticeship program
*** Job
**** Chef
**** Restaurant owner
*** Cost
**** 8-9K
*** Benefit
**** I don't really want to work in a restaurant unless I own it
...
| BIOL 105 |                        |
| BIOL 150 | BIOL 135               |
| BIOL 152 | BIOL 150 (PR: BIOL 135 |
| BIOL 154 | BIOL 135               |
| CHEM 130 | CHEM 124, 125          |
** 23-24
*** Fall 23
| class    | credits |
|----------+---------|
...
* Italy
*** TODO il passaporto
*** TODO Osterie d'italia
    - food guide
*** TODO italy plug adapter
*** TODO verizon international plan
*** TODO clothes
*** TODO journal
*** TODO museum tickets
*** TODO art class?
