...
** Week 1
  ...
  #+CAPTION: Clock summary at [2022-03-12 Sat 20:47], for week 2022-W10.
  | Tags | Headline     | Time   |
  |------+--------------+--------|
  |      | *Total time* | *0:00* |
  #+END:
...
** Week 6
  ...
  |         | \_      Brainstorm CABC assignment 7 |         |       |      | 2:23 |
  #+END:
  
  #+BEGIN: clocktable-by-tag :maxlevel 6 :match ("drawing" "study" "painting")
  | Tag      | Headline   | Time (h)  |
  |----------+------------+-----------|
  | drawing  | *Tag time* | *23h 18m* |
  |----------+------------+-----------|
  | study    | *Tag time* | *2h 53m*  |
  |----------+------------+-----------|
  | painting | *Tag time* | *0h 0m*   |
...
**** DONE Brainstorm CABC week 7                                      :study:
     ...
     :END:
**** DONE Brainstorm CABC assignment 7
     :LOGBOOK:
