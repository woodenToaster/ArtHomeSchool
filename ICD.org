...
** Homework
   ...
   - [-] modeling
     ...
     - [ ] more interesting dipper stucture
     - [ ] make dipper bigger
     - [ ] chimney
     - [ ] windows to light the FPs instead of candles?
     - [ ] break up long stretches of same materials
     - [ ] separate dome and floor
   - [ ] line drawing
     - [ ] wood beams should be misshapen
     - [ ] test with freestyle render
     - [ ] transition stone to wood
     - [ ] base
     - [ ] line weight FP
     - [ ] details FP out
** Questions
   ...
   - [X] sketchup -> linework -> painting vs. blender render with materials
