...
** Critique
   - [ ] bushes don't look like plants. add some leaf texture
   - [ ] barrel overhangs. extend floor
   - [X] candle light is too saturated
   - [ ] overlap grass on building
   - [ ] prop on left of store front
   - [ ] hard to tell which direction the light is coming from. add shadows
   - [ ] shadows on center wood pillar
   - [ ] fire in the chimney
   - [ ] clean up grass
   - [X] fix dirt color
   - [ ] differentiate candles in vat from wood
   - [ ] rework wax
   - [ ] something with life that animates
   - [ ] wood grain by candle holders
   - [ ] thicker wick, add line weight
