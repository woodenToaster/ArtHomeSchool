...
** Critique
   - drawing
     ...
     - [X] fix wax clumps
   - painting
     - [ ] more neutral candle color
     - [ ] texture to break up solid colors
     - [ ] make wheel more interesting (ropes)
     - [ ] fill in boxes
     - [ ] more subtle variety in candle color
     - [ ] can use blue as accent color
     - [ ] spinning wheel and cotton bale are same color
* Week 8
** Critique
** Homework
* Week 9
