...
*** Why
    - Making shoes for the nobility
** Description
** Inventory
   - ankle shoes
   - poulaine (stuffed with moss or hair to hold the point)
   - boots
   - socks?
   - laces
   - lasts (wooden blocks in the shape of a foot)
   - pattens
   - leather bands
   - cordovan leather pieces
   - rolls of leather
   - benches
   - tools
   - apron
...
** Critique
   ...
   - [ ] rework wax
* Week 9 <2022-09-03 Sat>
** Critique
   - [X] communicate wick boxes better
   - [X] some random, and some clear indication for bushes
   - [X] 1 2 3 read on every object
   - [X] cast shadows on every object
   - [X] more contrast arond candle flames
   - [X] finish wood pile
   - try different designs instead of putting same things in every sketch
   - don't do an open room with assests hugging walls and something in middle
   - house outline is too random and jagged
   - 2 floor designs are more effective
* Week 10 <2022-09-10 Sat>
** Critique
   - sales person needs table and chair
   - eye is drawn to text
   - variation on boxy tables
   - paint light effects on surfaces instead of airbrushing
